...
namespace OrderBook
{
    ...
    {
        public static AddMessage Create(int sequenceNumber, BinaryReader reader)
        {
            ...
            reader.ReadBytes(4);
            return new AddMessage(sequenceNumber, symbol, orderId, side, size, price);
        }

        internal AddMessage(int sequenceNumber, string symbol, int orderId, Side side, int size, int price)
        {
